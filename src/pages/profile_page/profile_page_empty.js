      ...
      <Show_Detail>
        <Box display="flex" flex="1" marginLeft="5%" marginTop="6%" flexDirection="column" marginRight="5%" position="relative">
          <Camera_move1 display="flex" flex="210" width="100%">
            ...
            <Drag_reposition display="none" position="absolute" top="40%" left="40%" width="25%" height="40px" bgcolor="#FCFCFC" borderRadius="8px" fontSize="20px" fontWeight="300" fontFamily="Work Sans" alignItems="center" justifyContent="center">
              Drag to reposition{"\u00a0"}
              {"\u00a0"}
              <FiMove />
            </Drag_reposition>
        ...
        <Box display="flex" flex="1" marginLeft="5%" marginRight="5%" marginTop="5%">
          <Box display="flex" flex="1" flexDirection="column" justifyContent="center" marginLeft="5%">
            <Detail_Letter0 display="flex" alignItems="flex-start" fontFamily="Work Sans" fontSize="24px" fontWeight="600">
              Name
