...
import CardImage from "../../images/cover/cover-1.png";
  ...
  return (
    <>
      <OfferMain pb="80px">
        ...
        <CardGroup>
          <Box width="231px" height="311px" border="1px solid #CECECE" display="flex" flexDirection="column" borderRadius="8px" overflow="hidden">
            <Box mt-37px height="120px">
              <img src={CardImage} alt="" style={{ width: "100%" }} />
            </Box>
            <Box position="relative" flexGrow="1" display="flex" flexDirection="column" alignItems="center">
